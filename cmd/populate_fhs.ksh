...
COPA=${COPA:-/dsk/0v}
directory_tree=({bin,boot,dev,etc/{,skel},lib,lib64,opt,proc,run,sbin,sys,tmp,usr/{,bin,ccs,etc,include,lib,lib64,sbin,share/{,doc,man,misc},skel,spool,src,tmp},var/{,adm,cache,lib/{,color,misc},log,mail,tmp,run/{,lock},spool/{,mail}}})
